...
failed_list_path='data/recognization_failed_list_1.txt'
intermidiate_variables_folder_path='data/Intermediate_variables_1'
...
for file in failed_list:
    ...
    for i in range(masks_num):
        ...
        boundary_list,x_coords,y_coords=get_mask_border(selected_mask=masks[i],height=im.shape[0],width=im.shape[1])
        ...
        cv.waitKey(0)
        print(f"still remain {masks_num-i} masks")
